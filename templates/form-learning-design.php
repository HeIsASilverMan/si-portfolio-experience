...
>
    ...
    <div class="si-form__success" aria-hidden="true" role="status">
        ...
        <p class="si-form__success-sub"><?php echo esc_html( si_setting( 'form_ld_success', "Thanks for reaching out. I'll review your brief and be in touch within 2 working days." ) ); ?></p>
    </div>
